...
<template>
  ...
  <section class="mb-8 animate-fade-in">
    <div class="rounded-xl bg-raised backdrop-blur-sm border border-line px-5 py-4">
      <div class="flex items-center gap-1.5 mb-3">
        ...
        <span class="text-[10px] font-black text-ink-mute uppercase tracking-widest">本课学习动线</span>
      ...
      <div class="flex flex-wrap items-center gap-x-1.5 gap-y-2">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-3 h-3 text-ink-mute shrink-0">
          <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
        </svg>
        ...
        <button
          ...
          :class="completed
            ? 'border-emerald-500/40 bg-emerald-500/10 text-emerald-500 hover:border-emerald-500/60'
            : 'border-dashed border-line-strong bg-transparent text-ink-mute hover:border-emerald-500/60 hover:text-emerald-500'"
