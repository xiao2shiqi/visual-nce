...
<template>
  <div class="sticky top-0 z-20 pb-4 bg-[#fafbfc] border-b border-slate-200/60 -mx-6 px-6 lg:relative lg:mx-0 lg:px-0 lg:pb-0 lg:bg-transparent lg:border-b-0 lg:z-auto">
        ...
        <div class="flex items-center justify-between text-white pointer-events-auto">
          ...
          <div class="flex items-center gap-2">
            <div v-if="localIsPlaying" class="flex gap-0.5 h-3 items-end">
              <div class="w-0.5 bg-blue-400 animate-[waveBar_0.8s_ease-in-out_infinite]"></div>
              <div class="w-0.5 bg-blue-400 animate-[waveBar_1.2s_ease-in-out_infinite]"></div>
              <div class="w-0.5 bg-blue-400 animate-[waveBar_1s_ease-in-out_infinite]"></div>
            </div>
